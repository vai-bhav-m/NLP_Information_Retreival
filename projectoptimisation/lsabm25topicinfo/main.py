...
class SearchEngine:
	...
	def evaluateDataset(self, n_comp, k1, b, title_w):
		"""
		...
		self.informationRetriever.buildIndex(processedDocs, processedTitles, doc_ids, n_comp, k1, b, title_w)
...
if __name__ == "__main__":
	...
	if args.custom:
		...
		searchEngine.evaluateDataset(10,10,10,10)