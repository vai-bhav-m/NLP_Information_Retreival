...
class SearchEngine:
	...
	def evaluateDataset(self, n_components, k1, b):
		"""
		...
		self.informationRetriever.buildIndex(processedDocs, doc_ids, n_components, k1, b)
...
if __name__ == "__main__":
	...
	if args.custom:
		...
		searchEngine.evaluateDataset(100, 10, 10)